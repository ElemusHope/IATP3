...
public class PlateauDominosTest {
 @Before
    public void init() {
    ...
    public void testPlateauDominos(){
     ...
     while (!jeufini) {
         ...
         if (lesCoupsPossibles.size() > 0) {
             ...
             CoupJeu test = new CoupDominos(2,2);
             System.out.println("Coup joué : " + test + " par le joueur " + lesJoueurs[jnum]);
             plateauCourant.joue(lesJoueurs[jnum], test);
